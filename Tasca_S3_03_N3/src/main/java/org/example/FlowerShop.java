...
import org.example.MongoDBConnection.MongoDBDAOImpl;
...
public class FlowerShop {
	...
	private MongoDBDAOImpl instanceMongoDBDAOImpl;
	...
	public void finalizeTicket(Ticket ticket){
		...
		if(!ticket.getProducts().isEmpty()) {
			...
			instanceMongoDBDAOImpl.insertTicket(ticket);
		}
	}
    ...
    public void showTickets(){
		instanceMongoDBDAOImpl.getTickets().forEach(t-> System.out.println("ID: " + t.getId() + " - Total Value: " + t.getPrice() + "€."));
    }
